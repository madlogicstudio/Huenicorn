    ...
    <section className="w-full flex flex-row items-center justify-center gap-3 p-3">
        ...
        <div className="lg:h-[600px] h-auto max-w-[1080px] w-full flex lg:flex-row flex-col items-center justify-between lg:gap-0 gap-6 py-6">
            ...
            <div className='flex-1 flex flex-col lg:items-start items-center gap-6 '>
                ...
                <span className="fadeIn font-sans font-semibold lg:text-lg text-md lg:text-left text-center cursor-pointer text-foreground/60 hovered">
                    Generate palettes, extract colors, convert formats, check accessibility,  and build CSS-ready color tools.   
                </span>

                <div className="fadeIn w-38 flex items-center justify-between gap-1 text-foreground/80 button-hovered border border-foreground/20 px-4 py-2 rounded-full cursor-pointer
                    hover:text-[#5578C9] hover:border-transparent lg:mb-0 mb-6">
            ...
            <div className='relative flex-1 lg:flex hidden flex-col items-center justify-center gap-3 rounded-lg bg-[var(--secondary)]/80'>
                <Image src="/Icon.png" height={320} width={320} alt="Huenicorn-icon" className="cursor-pointer rotate-y-200 scale-125" />
            ...
            <div className='flex-1 w-[80%] lg:hidden flex flex-col items-center justify-center gap-3 rounded-lg bg-[var(--secondary)]/80'>
                <Image src="/Icon.png" height={180} width={180} alt="Huenicorn-icon" className="cursor-pointer rotate-y-200 scale-125" />
            </div>
